...
{\color{incolor}In [{\color{incolor}41}]:} \PY{c+c1}{\PYZsh{} Import libraries necessary for this project}
...
formatted.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{data}\PY{o}{.}\PY{n}{income}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}42}]:} <=50K    34014
         >50K     11208
         Name: income, dtype: int64
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{c+c1}{\PYZsh{} TODO: Total number of records}
         ...
         \PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{o}{.}\PY{n}{income}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZgt{}50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         
         \PY{c+c1}{\PYZsh{} TODO: Number of records where individual\PYZsq{}s income is at most \PYZdl{}50,000}
         \PY{n}{n\PYZus{}at\PYZus{}most\PYZus{}50k} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{o}{.}\PY{n}{income}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZlt{}=50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
...
the range of the values present and how they are distributed.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{c+c1}{\PYZsh{} Split the data into features and target label}
...
distributed.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{c+c1}{\PYZsh{} Log\PYZhy{}transform the skewed features}
...
for this.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{c+c1}{\PYZsh{} Import sklearn.preprocessing.StandardScaler}
...
with "\textgreater{}50K" to \texttt{1}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{n}{income\PYZus{}raw}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}47}]:} <=50K    34014
         >50K     11208
         Name: income, dtype: int64
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{c+c1}{\PYZsh{} TODO: One\PYZhy{}hot encode the \PYZsq{}features\PYZus{}log\PYZus{}minmax\PYZus{}transform\PYZsq{} data using pandas.get\PYZus{}dummies()}
         ...
         \PY{n}{income} \PY{o}{=} \PY{n}{income\PYZus{}raw}\PY{o}{.}\PY{n}{map}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZlt{}=50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZgt{}50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{1}\PY{p}{\PYZcb{}}\PY{p}{)}
         ...
         \PY{n}{display}\PY{p}{(}\PY{n}{features\PYZus{}final}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
[5 rows x 103 columns]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{n}{income}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}49}]:} 0    34014
         1    11208
         Name: income, dtype: int64
\end{Verbatim}
...
Run the code cell below to perform this split.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{c+c1}{\PYZsh{} Import train\PYZus{}test\PYZus{}split}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{n}{TP} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{income}\PY{p}{)} \PY{c+c1}{\PYZsh{} Counting the ones as this is the naive case. Note that \PYZsq{}income\PYZsq{} is the \PYZsq{}income\PYZus{}raw\PYZsq{} data }
         \PY{c+c1}{\PYZsh{} encoded to numerical values done in the data preprocessing step.}
         \PY{n}{FP} \PY{o}{=} \PY{n}{income}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{TP} \PY{c+c1}{\PYZsh{} Specific to the naive case}
         ...
         \PY{n}{accuracy} \PY{o}{=} \PY{n}{TP}\PY{o}{/}\PY{n}{income}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         ...
         \PY{n}{fscore} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{beta}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{n}{precision}\PY{o}{*}\PY{n}{recall}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{p}{(}\PY{n}{beta}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{*} \PY{n}{precision}\PY{p}{)}\PY{o}{+}\PY{n}{recall}\PY{p}{)}
...
\begin{itemize}
\item
  Could be used effectively to analyze a bag of words problem, such as
  classifiying an email as spam.
\item
  Simple probabalistic interpretation, and the algorithm can be
  regularized to avoid overfitting. Logistic regression models can be
  fit relatively inexpensively.
\item
  May not be flexible enough to interpret multiple nonlinear decision
  boundaries.
\item
  This is a good first choice because it is inexpensive to implement,
  and because we have already normalized our data. It will avoid
  overfitting the data and scale well with a large dataset. Since we do
  not know the impact of each feature yet, it will provide a good
  contrast to decision-tree based methods later.
\item
  references:
  \href{https://elitedatascience.com/machine-learning-algorithms\#classification}{Elite
  Data Science},
  \href{https://www.quora.com/What-are-applications-of-linear-and-logistic-regression}{Quora}
\end{itemize}
...
\begin{itemize}
\item
  Could be applied in a scenario where one is trying to predict if a
  user profile is prone to defaulting on a loan.
\item
  Robust to outliers, and model multiple nonlinear decision boundaries
  well.
\item
  Prone to overfitting if not constrained well, as it is built on
  decision tree weak learners.
\item
  I've chosen this as a second model to try because it excels in
  modeling nonlinear feature interactions, which is a weakness of the
  logistic regression tested prior. Since our data has many features, it
  should be an effective model.
\item
  references:
  \href{https://elitedatascience.com/machine-learning-algorithms\#classification}{Elite
  Data Science},
  \href{https://en.wikipedia.org/wiki/AdaBoost}{Wikipedia}
\end{itemize}
...
\begin{itemize}
\item
  Could be applied to identify a patient's illness by analyzing their
  medical record.
\item
  As an ensemble method, they naturally perform well on datasets with a
  high number of features, and the Random Forest algorithm avoids
  overfitting better than other ensemble methods. Random forests also
  are less memory intensive than some other models.
\item
  Sensitive to overfitting if a dataset is particularly noisy.
\item
  I've chosen this method because we are working with a large dataset
  comprised of many features, and I want to continue using
  non-memory-intensive models. As an ensemble method it should perform
  well with our featureset, and may be less prone to overfitting than
  AdaBoost.
\item
  references:
  \href{https://www.newgenapps.com/blog/random-forest-analysis-in-ml-and-when-to-use-it}{newgenapps},
  \href{http://blog.citizennet.com/blog/2012/11/10/random-forests-ensembles-and-performance-metrics}{CitizenNet},
  \href{https://en.wikipedia.org/wiki/Random_forest}{Wikipedia} 
\end{itemize}
...
\texttt{beta} parameter!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{n}{X\PYZus{}test}\PY{o}{.}\PY{n}{sample}\PY{p}{(}\PY{n}{n}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}52}]:}             age  education-num  capital-gain  capital-loss  hours-per-week  \textbackslash{}
         14468  0.506849       0.533333      0.707941           0.0        0.397959   
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{c+c1}{\PYZsh{} TODO: Import two metrics from sklearn \PYZhy{} fbeta\PYZus{}score and accuracy\PYZus{}score}
         ...
         \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
             ...
             \PY{c+c1}{\PYZsh{}       using .fit(training\PYZus{}features[:], training\PYZus{}labels[:])}
             \PY{n}{start} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)} \PY{c+c1}{\PYZsh{} Get start time}
             \PY{c+c1}{\PYZsh{} learner.fit(X\PYZus{}train.sample(n=sample\PYZus{}size), y\PYZus{}train.sample(n=sample\PYZus{}size))}
...
implementation may take some time to run!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{c+c1}{\PYZsh{} TODO: Import the three supervised learning models from sklearn}
         ...
         \PY{n}{clf\PYZus{}A} \PY{o}{=} \PY{n}{LogisticRegression}\PY{p}{(}\PY{p}{)}
         \PY{n}{clf\PYZus{}B} \PY{o}{=} \PY{n}{AdaBoostClassifier}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{13}\PY{p}{)}
         \PY{n}{clf\PYZus{}C} \PY{o}{=} \PY{n}{RandomForestClassifier}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{samples\PYZus{}10} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{10}\PY{p}{)}
         \PY{n}{samples\PYZus{}1} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{100}\PY{p}{)}
...
I believe that the AdaBoost model is going to be most appropriate for
the task, as it has the highest F-score on the testing data when 100\%
of the data is used. Although the AdaBoost is the most time intensive by
far, it is still remarkably fast, and the training time is negligible.
Note that the AdaBoost classifier is outperformed by the Random Forest
classifier in terms of F-score and accuracy on the training set, but
then it outperforms the Random Forest classifier on the testing sets.
The default random forest classifier is overfitting the training data,
whereas the AdaBoost classifier's f-scores on the testing and training
datasets are comparable, suggesting it is not overfitting. Decision
trees like AdaBoost and Random Forest are well suited to problems with
many features such as this one, and it makes sense to choose the one
...
The AdaBoost classifier is what is known as an ensemble method, meaning
that is actually a classifier comprised of many 'weak learners', or
simple classifiers, which it trains on subsets of the data and then has
vote on classification when asked to predict an outcome. What makes the
AdaBoost algorithm unique is that it iteratively trains its weak
learners on the dataset, adjusting the impact of misclassification each
training round to push each new weak learner to improve on the mistakes
of all the learners before it. Finally, it assigns each weak learner a
weight based on the accuracy it achieved which impacts how valuable its
vote is when a prediction is made. As a decision tree, AdaBoost is well
suited for handling many complex features as we have in this program,
and as an ensemble method it uses the concept of voting to try to reduce
the potential for memorizing the training data. 
...
the following implementation may take some time to run!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}55}]:} \PY{c+c1}{\PYZsh{} TODO: Import \PYZsq{}GridSearchCV\PYZsq{}, \PYZsq{}make\PYZus{}scorer\PYZsq{}, and any other necessary libraries}
         ...
         \PY{n}{clf} \PY{o}{=} \PY{n}{AdaBoostClassifier}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{13}\PY{p}{)}
         ...
         \PY{n}{parameters} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n\PYZus{}estimators}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{p}{[}\PY{l+m+mi}{50}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{,} \PY{l+m+mi}{300}\PY{p}{,} \PY{l+m+mi}{500}\PY{p}{]}\PY{p}{,} \PYZbs{}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{learning\PYZus{}rate}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{p}{[}\PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mf}{1.25}\PY{p}{,} \PY{l+m+mf}{1.5}\PY{p}{,} \PY{l+m+mf}{1.75}\PY{p}{,} \PY{l+m+mf}{2.}\PY{p}{]}\PY{p}{\PYZcb{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
C:\textbackslash{}Users\textbackslash{}Jesse\textbackslash{}Anaconda3\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}sklearn\textbackslash{}metrics\textbackslash{}classification.py:1135: UndefinedMetricWarning: F-score is ill-defined and being set to 0.0 due to no predicted samples.
...
\end{longtable}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}56}]:} \PY{n}{grid\PYZus{}fit}\PY{o}{.}\PY{n}{best\PYZus{}estimator\PYZus{}}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}56}]:} AdaBoostClassifier(algorithm='SAMME.R', base\_estimator=None,
                   learning\_rate=1.5, n\_estimators=500, random\_state=13)
\end{Verbatim}
            
    \textbf{Answer: }

Both the accuracy score and F-score improved in the optimized model, as
expected. The improvements were marginal, and the best estimator's
parameters indicated that increasing the number of weak learners led to
an increase inscoring metrics (with diminishing returns), although
increasing the learning rate did not necessarily. 
...
important for prediction, and in what order would you rank them and why?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}57}]:} \PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{education\PYZhy{}num}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}57}]:} 9.0     14783
         10.0     9899
         13.0     7570
         14.0     2514
         11.0     1959
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}58}]:} \PY{n}{data}\PY{o}{.}\PY{n}{columns}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}58}]:} Index(['age', 'workclass', 'education\_level', 'education-num',
                'marital-status', 'occupation', 'relationship', 'race', 'sex',
                'capital-gain', 'capital-loss', 'hours-per-week', 'native-country',
                'income'],
               dtype='object')
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}59}]:} \PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{race}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}59}]:}  White                 38903
          Black                  4228
...
There are several features in this dataset that I expect to contribute
heavily towards an individual's annual earnings.

\begin{enumerate}
\def\labelenumi{\arabic{enumi})}
\item
  \textbf{Captial Losses:} This will obviously directly impact an
  individuals net earnings, as if they are paying off loans or other
  debt their yearly takeaway will diminish heavily. I expect many
  surveyed also own depreciating assets, such as cars.
\item
  \textbf{Age:} Numerous studies have shown that an individual's earning
  potential increases with age up to a threshold value. Persons between
  35-40 have a higher earning potential than persons 25-30 because they
  have more industry experience and job skills.
\item
  \textbf{Captial Gains:} This will also directly impact an individuals
  net earnings, but I suspect fewer people are profiting from the sales
  of assets than are losing from depreciating assets (captial losses) so
  it will play a smaller role. Those who are profiting from captial
  gains are also more likely to be older, which puts this feature behind
  age in terms of importance.
\item
  \textbf{Hours per Week:} Very simply, any individual working a full 40
  hours per week is more likely to have a higher income than one working
  part time at 20-30 hours per week. A part time worker is much more
  likely to be working at an hourly rate as opposed to a salary as well,
  which in all likelihood decreases their earning ceiling. I put this
  4th on the list because I suspect more of those surveyed are probably
  working 40 hours per week, making this more of an edge case.
\item
  \textbf{Education-num:} Numerous studies have also shown that a
  person's earning potential is correlated with their education level.
  The only reason I place this last on the list is because I think that
  once regularized, the difference between education levels may be
  misleadingly small.
\end{enumerate}
...
\texttt{\textquotesingle{}.feature\_importances\_\textquotesingle{}}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}60}]:} \PY{c+c1}{\PYZsh{} TODO: Import a supervised learning model that has \PYZsq{}feature\PYZus{}importances\PYZus{}\PYZsq{}}
         
         
         \PY{c+c1}{\PYZsh{} TODO: Train the supervised model on the training set using .fit(X\PYZus{}train, y\PYZus{}train)}
         \PY{n}{model} \PY{o}{=} \PY{n}{AdaBoostClassifier}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}61}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         \PY{k}{def} \PY{n+nf}{feature\PYZus{}plot2}\PY{p}{(}\PY{n}{importances}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{columns} \PY{o}{=} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{columns}\PY{o}{.}\PY{n}{values}\PY{p}{[}\PY{n}{indices}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}\PY{p}{]}
             \PY{n}{values} \PY{o}{=} \PY{n}{importances}\PY{p}{[}\PY{n}{indices}\PY{p}{]}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}
             ...
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Normalized Weights for First Ten Most Predictive Features}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{fontsize} \PY{o}{=} \PY{l+m+mi}{16}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{,} \PY{n}{values}\PY{p}{,} \PY{n}{width} \PY{o}{=} \PY{l+m+mf}{0.6}\PY{p}{,} \PY{n}{align}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{center}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsh{}00A000}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PYZbs{}
                   \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Feature Weight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{l+m+mf}{0.3}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{cumsum}\PY{p}{(}\PY{n}{values}\PY{p}{)}\PY{p}{,} \PY{n}{width} \PY{o}{=} \PY{l+m+mf}{0.2}\PY{p}{,} \PY{n}{align} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{center}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsh{}00A0A0}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PYZbs{}
                   \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Cumulative Feature Weight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{,} \PY{n}{columns}\PY{p}{,} \PY{n}{rotation}\PY{o}{=}\PY{l+m+mi}{90}\PY{p}{)}
             \PY{c+c1}{\PYZsh{}plt.xlim((\PYZhy{}0.5, 4.5))}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}62}]:} \PY{n}{feature\PYZus{}plot2}\PY{p}{(}\PY{n}{importances}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}
\end{Verbatim}
...
This answer confirms my suspicions exactly. The top 5 features I
predicted together account for over 50\% of the model weight. If we
expand the list, we can see that race\_White makes it into the top 7
which is not too surprising, I suspect it is only that low on the list
because the vast majority of the sampled population is white. The same
logit applies for why the education\_level\_Masters is lower on the list
than education\_level\_Bacherlors - although Master's degrees increase
earning potential drastically, many more participants have a bachelor's
degree or lower than have a master's.
...
training set \emph{with only the top five important features}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}63}]:} \PY{c+c1}{\PYZsh{} Import functionality for cloning a model}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}68}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Accuracy reduction: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{l+m+mi}{1} \PY{o}{\PYZhy{}} \PY{n}{accuracy\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{reduced\PYZus{}predictions}\PY{p}{)}\PY{o}{/}\PY{n}{accuracy\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{best\PYZus{}predictions}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{F\PYZhy{}score reduction: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{l+m+mi}{1} \PY{o}{\PYZhy{}} \PY{n}{fbeta\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{reduced\PYZus{}predictions}\PY{p}{,} \PY{n}{beta} \PY{o}{=} \PY{l+m+mf}{0.5}\PY{p}{)}\PY{o}{/}\PY{n}{fbeta\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{best\PYZus{}predictions}\PY{p}{,} \PY{n}{beta} \PY{o}{=} \PY{l+m+mf}{0.5}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
Accuracy was reduced by 3\%, and the F-score was reduce by 6\%. Deciding
to reduce the training set data poses a cost-benefit question that would
have to be analyzed on its own before pursuing either option. It is
possible that opting to use a full dataset at the cost of time could
pose direct costs via overhead, and indirect costs via schedule delays
or missed opportunities. However, it could be that a small reduction in
precision or recall could translate into a reduction in ROI which would
scale over time, or it could mean missed fraud or medical diagnoses
immediately which would pose issues for a business.

In this case, the reduction in f-score would translate into
misclassifying a few hundred potential donors as earning
\textgreater{}50K/year, and would result in a marginally lower return on
investment in promotional material and postage. Running my optimized
model on the full dataset only takes a few minutes, so it is worth it to
run the complete model. However, if the client decided to use a larger
dataset which could delay my model fitting by days or weeks, it would
likely be worth the tradeoff.
